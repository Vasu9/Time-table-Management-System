...
if (isset($_POST['cancel'])) {
	...
	if(!$result ){
		die("<SCRIPT LANGUAGE='JavaScript'>alert('Unknown Error Occured!')</script><script>location.href = 'domain_reply_mail.php'</script>");
	}
	$msg = "Message Sent.";
	...
	<div class='domain_form form-group' >
		...
		<form  action="domain_reply_mail.php" method="post" role="form" >
